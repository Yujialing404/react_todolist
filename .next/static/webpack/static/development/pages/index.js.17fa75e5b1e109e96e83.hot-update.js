...
function TodoList() {
  ...
  var remove = Object(react__WEBPACK_IMPORTED_MODULE_1__["useCallback"])(function (index) {
    data.splice(index, 1);
    listchange(data);
  })
  /* const remove = useEffect((index) => {
      data.splice(index,1)
      listchange(data)
  }) */
  ;
...
//# sourceMappingURL=index.js.17fa75e5b1e109e96e83.hot-update.js.map